/**
 * 
 * ShipmentPartBookingDimension.java
 * 
...
/**
 * This model class represents ShipmentPartBookingDimension Request from UI.
 * 
...
@AllArgsConstructor
@NoArgsConstructor
public class ShipmentPartBookingDimension extends BaseBO {
	/**
