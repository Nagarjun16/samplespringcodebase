...
@Service(value = "flightTouchDown")
public class ProduceSingPostMessageFlightTouchDownServiceImpl implements ProduceSingPostMessageService {
   ...
   public PushMailBagRequestModel pushMailBagStatus(PushMailBagRequestModel mailBagRequestModel)
      ...
      for (MailBagRequestModel bag : mailBagRequestModel.getMailBag()) {
         ...
         bagStatus.setBagStatus("LD");
         bagStatus.setFlightNumber("EY375");
