...
/**
 * <p>Java class for FindBookingTemplatesResponseData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FindBookingTemplatesResponseData">
 *   &lt;complexContent>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="bookingTemplate" type="{http://www.ibsplc.com/icargo/services/types/CapacityBookingService/2013/06/04_01}BookingTemplateType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "FindBookingTemplatesResponseData", propOrder = {
    "requestID",
    "status",
    "bookingTemplate",
    "errorDetails"
})
public class FindBookingTemplatesResponseData {

    @XmlElement(required = true)
    protected String requestID;
    @XmlElement(required = true)
    protected String status;
    protected List<BookingTemplateType> bookingTemplate;
     ...
     * This is why there is not a <CODE>set</CODE> method for the bookingTemplate property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getBookingTemplate().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BookingTemplateType> getBookingTemplate() {
        if (bookingTemplate == null) {
            bookingTemplate = new ArrayList<BookingTemplateType>();
        }
