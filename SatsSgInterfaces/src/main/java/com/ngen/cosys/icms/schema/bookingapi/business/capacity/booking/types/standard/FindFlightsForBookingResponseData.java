...
/**
 * <p>Java class for FindFlightsForBookingResponseData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FindFlightsForBookingResponseData">
 *   &lt;complexContent>
 ...
 *           &lt;/simpleType>
 *         &lt;/element>
 *         &lt;element name="flightDetails" type="{http://www.ibsplc.com/icargo/services/types/CapacityBookingService/2013/06/04_01}FlightMapType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "FindFlightsForBookingResponseData", propOrder = {
    "requestID",
    "status",
    "flightDetails",
    "errorDetail"
})
public class FindFlightsForBookingResponseData {

    @XmlElement(required = true)
    protected String requestID;
    @XmlElement(required = true)
    protected String status;
    protected List<FlightMapType> flightDetails;
     ...
     * 
     */
    public List<FlightMapType> getFlightDetails() {
        if (flightDetails == null) {
            flightDetails = new ArrayList<FlightMapType>();
        }
