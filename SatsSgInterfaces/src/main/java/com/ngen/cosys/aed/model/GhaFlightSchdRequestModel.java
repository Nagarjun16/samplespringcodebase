...
@NoArgsConstructor
@ApiModel
@JacksonXmlRootElement(localName = "GHAFLIGHTSCHD")
...
@JsonPropertyOrder(value = { "GHAFLIGHTSCHD", "HEADER", "DETAIL" })
public class GhaFlightSchdRequestModel extends BaseBO {
   ...
   private GhaFlightSchdRequestDetails details;
