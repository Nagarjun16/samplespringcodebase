...
public class SingaporeCustomsDataSyncProducer {
	private final ApplicationEventPublisher publisher;

	@Autowired
	public SingaporeCustomsDataSyncProducer(ApplicationEventPublisher publisher) {
		this.publisher = publisher;
	}

	public void publish(SingaporeCustomsDataSyncEvent event) {
