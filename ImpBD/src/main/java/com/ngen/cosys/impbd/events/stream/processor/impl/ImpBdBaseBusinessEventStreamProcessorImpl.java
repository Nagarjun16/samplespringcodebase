...
public class ImpBdBaseBusinessEventStreamProcessorImpl implements ImpBdBaseBusinessEventStreamProcessor {

	private static final Logger LOGGER = LoggerFactory.getLogger(ImpBdBaseBusinessEventStreamProcessor.class);
