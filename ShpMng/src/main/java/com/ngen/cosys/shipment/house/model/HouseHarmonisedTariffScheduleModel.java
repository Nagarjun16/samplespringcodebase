...
public class HouseHarmonisedTariffScheduleModel extends BaseBO {
   ...
   @Size(max = 18, message = "data.min.max.length.required", groups = { HouseWayBillValidationGroup.class })
