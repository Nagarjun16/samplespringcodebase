...
@SpringBootTest
public class NeutralAWBControllerTDDTest {
	...
	private final String shipperName = "Shyam";
	private final String consigneeName = "Shyam";
	...
	public void setUp() throws CustomException {
	   sidHeaderDetail = new SIDHeaderDetail();
		...
		sidHeaderDetail1.setConsigneeName("Kaushlender");
	...
	public void testSearchSIDListFailScenarioWithNull() throws CustomException {
		...
		assertEquals(sidHeaderDetails.isEmpty(), neutralAWBService.searchSIDList(searchSIDRQ).isEmpty());
	...
	public void testsearchSIDListBySIDNumberSuccessScenario() throws CustomException {
		...
		assertEquals(1, neutralAWBService.searchSIDList(searchSIDRQ).size());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(0));
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(0).getConsigneeName());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(0).getShipperName());
		assertEquals(sidHeaderDetails.get(0).getSidNumber(),
				neutralAWBService.searchSIDList(searchSIDRQ).get(0).getSidNumber());
		assertEquals(sidHeaderDetails.get(0).getShipmentNumber(),
				neutralAWBService.searchSIDList(searchSIDRQ).get(0).getShipmentNumber());
		assertEquals(sidHeaderDetails.get(0).getSidHeaderId(),
				neutralAWBService.searchSIDList(searchSIDRQ).get(0).getSidHeaderId());
		assertEquals(sidHeaderDetails.get(0).getStatus(),
				neutralAWBService.searchSIDList(searchSIDRQ).get(0).getStatus());
		assertEquals(sidHeaderDetails.get(0).getCreatedBy(),
				neutralAWBService.searchSIDList(searchSIDRQ).get(0).getCreatedBy());
	...
	public void testsearchSIDListSuccessScenario() throws CustomException {
		...
		SearchSIDRQ searchSIDRQ = new SearchSIDRQ();
		assertEquals(2, neutralAWBService.searchSIDList(searchSIDRQ).size());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(0));
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(0).getConsigneeName());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(0).getShipperName());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(0).getSidNumber());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(0).getShipmentNumber());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(0).getSidHeaderId());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(0).getStatus());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(0).getCreatedBy());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(1));
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(1).getConsigneeName());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(1).getShipperName());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(1).getSidNumber());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(1).getShipmentNumber());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(1).getSidHeaderId());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(1).getStatus());
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ).get(1).getCreatedBy());
	...
	//	paymentInfo.setCarriageValueDeclaration("1.00");
		...
		equals(nawbMaster.getShipperInfo().getCustomerAddressInfo().getPostalCode());
		...
		assertNotNull(neutralAWBService.searchSIDList(searchSIDRQ));
	}
	...
	public void testsearchStockByStockIdCarrierCodeCategoryCodeSuccessScenario() throws CustomException {
		...
		assertEquals(1, neutralAWBService.searchAWBFromStockList(searchStockRQ).size());
		assertNotNull(neutralAWBService.searchAWBFromStockList(searchStockRQ).get(0));
		assertEquals(stocks.get(0).getAwbStockDetailsId(),
				neutralAWBService.searchAWBFromStockList(searchStockRQ).get(0).getAwbStockDetailsId());
		assertEquals(stocks.get(0).getAwbStockId(),
				neutralAWBService.searchAWBFromStockList(searchStockRQ).get(0).getAwbStockId());
		assertEquals(stocks.get(0).getAwbNumber(),
				neutralAWBService.searchAWBFromStockList(searchStockRQ).get(0).getAwbNumber());
		assertEquals(stocks.get(0).getStockId(),
				neutralAWBService.searchAWBFromStockList(searchStockRQ).get(0).getStockId());
		assertEquals(stocks.get(0).getStockCategoryCode(),
				neutralAWBService.searchAWBFromStockList(searchStockRQ).get(0).getStockCategoryCode());
	...
	public void testsearchStockByCarrierCodeSuccessScenario() throws CustomException {
		...
		SearchStockRQ searchStockRQ = new SearchStockRQ();
		searchStockRQ.setCarrierCode(carrierCode);
		assertEquals(2, neutralAWBService.searchAWBFromStockList(searchStockRQ).size());
		assertNotNull(neutralAWBService.searchAWBFromStockList(searchStockRQ).get(0));
		assertEquals(stocks.get(0).getAwbStockDetailsId(),
				neutralAWBService.searchAWBFromStockList(searchStockRQ).get(0).getAwbStockDetailsId());
		assertEquals(stocks.get(0).getAwbStockId(),
		...
		assertEquals(stocks.get(1).getAwbStockDetailsId(),
				neutralAWBService.searchAWBFromStockList(searchStockRQ).get(1).getAwbStockDetailsId());
		assertEquals(stocks.get(1).getAwbStockId(),
				neutralAWBService.searchAWBFromStockList(searchStockRQ).get(1).getAwbStockId());
		assertEquals(stocks.get(1).getAwbNumber(),
				neutralAWBService.searchAWBFromStockList(searchStockRQ).get(1).getAwbNumber());
		assertEquals(stocks.get(1).getStockId(),
				neutralAWBService.searchAWBFromStockList(searchStockRQ).get(1).getStockId());
		assertEquals(stocks.get(1).getStockCategoryCode(),
				neutralAWBService.searchAWBFromStockList(searchStockRQ).get(1).getStockCategoryCode());
