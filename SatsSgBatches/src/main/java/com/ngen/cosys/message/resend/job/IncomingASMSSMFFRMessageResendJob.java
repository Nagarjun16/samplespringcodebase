/**
 * {@link IncomingASMSSMFFRMessageResendJob}
 * 
...
/**
 * Incoming ASM/SSM FFR Message Resend Job
 * 
 ...
 */
@Component(value = MessageResendConstants.INCOMING_ASM_SSM_FFR_MESSAGE_RESEND)
public class IncomingASMSSMFFRMessageResendJob extends AbstractCronJob implements MessageSequenceJob {

   private static final Logger LOGGER = LoggerFactory.getLogger(IncomingASMSSMFFRMessageResendJob.class);
   ...
   protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
      try {
         ...
         LOGGER.error("Incoming ESB ASM-SSM-FFR Message Resend Process exception occurred - {}", ex);
      }
   }
   ...
   public void messageSequenceReProcess() throws CustomException {
      ...
      LOGGER.info("Incoming ASM-SSM-FFR PROCESSING Message Logs Availability - {}, Size - {}",
      ...
      LOGGER.info("Incoming ASM-SSM-FFR Message PROCESSING Sequence Process Completed :: START TIME - {}, END TIME - {}",
   ...
   public void messageSequenceProcess() throws CustomException {
      LOGGER.info("Incoming ASM-SSM-FFR Message Sequence Process Initiated {}");
      LocalDateTime startTime = LocalDateTime.now();
      ...
      boolean messageLogsAvailability = !CollectionUtils.isEmpty(messageLogs) ? true : false;
      LOGGER.info("Incoming ASM-SSM-FFR INITIATED Message Logs Availability - {}, Size - {}",
            String.valueOf(messageLogsAvailability), messageLogs.size());
      if (messageLogsAvailability) {
         messageProcessor.process(messageLogs);
         logMessageSequenceProcessDetails(messageLogs);
      }
      LOGGER.info("Incoming ASM-SSM-FFR Message INITIATED Sequence Process Completed :: START TIME - {}, END TIME - {}",
            startTime, LocalDateTime.now());
   }
   ...
   public void logMessageSequenceProcessDetails(List<IncomingESBMessageLog> messageLogs) throws CustomException {
      LOGGER.info("Incoming ASM-SSM-FFR Message Sequence Process :: LOG Details - {}");
