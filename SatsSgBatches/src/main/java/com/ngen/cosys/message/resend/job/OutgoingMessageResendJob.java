...
/**
 * This implementation class is used for Outgoing Message Resends to External
 ...
 */
@Component(value = MessageResendConstants.OUTGOING_MESSAGE_RESEND)
public class OutgoingMessageResendJob extends AbstractCronJob implements MessageResendJob {
   ...
   public void messageResendProcess() throws CustomException {
      ...
      List<OutgoingErrorMessageLog> errorMessageLogs = messageResendService.getOutgoingErrorMessageLogs();
