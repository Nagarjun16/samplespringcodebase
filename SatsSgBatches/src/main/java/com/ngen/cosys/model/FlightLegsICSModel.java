...
@Setter
@NoArgsConstructor
@JsonIgnoreProperties(value = { "flightId", "createdBy", "createdOn", "modifiedBy", "modifiedOn", "flagUpdate", "flagDelete", "flagInsert", "flagSaved", "localDateFormat", "locale", "messageList", "flagCRUD", "tenantId", "terminal", "loggedInUser" })
public class FlightLegsICSModel extends BaseBO {
   /**
