...
public class DiscrepancyReport {
	   ...
	   private static final Logger logger = LoggerFactory.getLogger(DiscrepancyReport.class);
	private static final String MAIL_BODY1 = "Attached File: SVC_Report";
	   @PostMapping(value = "/api/batches/damageReports", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
