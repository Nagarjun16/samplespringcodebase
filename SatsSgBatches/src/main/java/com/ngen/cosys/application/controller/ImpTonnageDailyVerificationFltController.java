...
@NgenCosysAppInfraAnnotation(path ="/api/systemmonitoring/imptonnageFlt")
public class ImpTonnageDailyVerificationFltController {

   private static final Logger LOGGER = LoggerFactory.getLogger(ImpTonnageDailyVerificationFltController.class);
   private static final String TIME_FORMAT = "yyyy-MM-dd HH:mm:ss";
   private static final String DATE_FORMAT = "ddMMMyyyy";
   private static final String REPORT_NAME = "Import_Daily_Tonnage_Verification_Flt";
   private static final String MAIL_TEMPLATE = "Import Daily Tonnage Verification(Flight)";
   ...
   @ApiOperation("Get Flight from cosys")
	@PostMapping(value = "/api/batches/impdailyverificationflt", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public void ffmfwbMonitoring() throws CustomException {
	   LocalDateTime currentUTCTime = LocalDateTime.now();
	      ...
	      // Report Payload
	         ...
	         LOGGER.info("Import Tonnage Daily Verification Flt Shipment Job :: Import Tonnage list sent successfully");
	      }
