...
public class FFMFWBMonitoringController {
   ...
   private static final String FFM_MAIL_TEMPLATE = "FFM Monitoring Report";
   private static final String MAIL_BODY = "Attached File:";
   private static final String ONLYTIME_FORMAT = "HH:mm";
   private static final String FWB_REPORT_NAME = "FFMMonitoringReport";
   private static final String FWB_MAIL_TEMPLATE = "FFM Monitoring Report";
   ...
   @ApiOperation("Get Flight from cosys")
	@PostMapping(value = "/api/batches/ffmfwbmonitoring", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
