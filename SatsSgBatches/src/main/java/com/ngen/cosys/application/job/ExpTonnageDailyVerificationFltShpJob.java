/**
 * {@link ExpTonnageDailyVerificationFltShpJob}
 * 
 ...
 */
public class ExpTonnageDailyVerificationFltShpJob extends AbstractCronJob {

   private static final Logger LOGGER = LoggerFactory.getLogger(ExpTonnageDailyVerificationFltShpJob.class);
   ...
   protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
      ...
      // Report Payload
         ...
         LOGGER.info("Exp Tonnage Daily Verification Shipment Job :: Exp Tonnage Daily Verification Shipment list sent successfully");
      }
