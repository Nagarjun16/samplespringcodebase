...
public class EmbargoRulesMessagesJob extends AbstractCronJob {
   @Autowired
   ...
   private static final String messageName = "TGFMEMBL";
   ...
   protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
      ...
      MssMessageParentModel<List<EmbargoRulesMessageModel>> embargoRulesDataList = null;
      try {
         embargoRulesDataList = service.embargoRulesMessages(messageName);
      } catch (CustomException e) {
         throw new JobExecutionException(e.getCause());
      }
      // Send batch job data to Connector framework
      if (!CollectionUtils.isEmpty((List) embargoRulesDataList.getData())) {
         delegateToConnector(embargoRulesDataList, messageName);
      }
   }
