 ...
 */
public class Uldbtcoolportjob extends AbstractCronJob {
   ...
   protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
      ...
      LocalDateTime thirdShiftTime = LocalDateTime.of(currentZoneTime.plusHours(8).toLocalDate(), LocalTime.of(01, 29));
      //
