/**
 * {@link ImpTonnageDailyVerificationFltJob}
 * 
...
/**
 * Imp Tonnage Daily Verification Flight Job
 * 
 * @author NIIT Technologies Ltd
 */
public class ImpTonnageDailyVerificationFltJob extends AbstractCronJob {

   private static final Logger LOGGER = LoggerFactory.getLogger(ImpTonnageDailyVerificationFltJob.class);
   ...
   protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
      ...
      // Report Payload
         ...
         LOGGER.info("Imp Tonnage Daily Verification Flight Job :: Imp Tonnage Daily Verification Flight list sent successfully");
      }
