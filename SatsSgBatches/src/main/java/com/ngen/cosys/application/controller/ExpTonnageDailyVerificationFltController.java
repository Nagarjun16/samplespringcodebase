...
public class ExpTonnageDailyVerificationFltController {

   private static final Logger LOGGER = LoggerFactory.getLogger(ExpTonnageDailyVerificationFltController.class);
   ...
   @ApiOperation("Get Flight from cosys")
	@PostMapping(value = "/api/batches/expdailyverificationflt", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public void ffmfwbMonitoring() throws CustomException {
	   LocalDateTime currentUTCTime = LocalDateTime.now();
	      ...
	      // Report Payload
	         ...
	         LOGGER.info("Export Tonnage Daily Verification Flt Shipment Job :: Export Tonnage list sent successfully");
	      }
