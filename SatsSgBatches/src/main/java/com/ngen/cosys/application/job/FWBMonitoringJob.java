 ...
 */
public class FWBMonitoringJob extends AbstractCronJob {

   private static final Logger LOGGER = LoggerFactory.getLogger(FWBMonitoringJob.class);
   ...
   private EMailEvent getEmailPayload(List<String> emailAddresses, boolean exportList, LocalDateTime currentZoneTime) {
      ...
      String fileName = null;
         fileName = shiftFileNameFormat(FWB_REPORT_NAME, currentZoneTime);
         emailEvent.setMailSubject(mailSubject(FWB_MAIL_TEMPLATE, currentZoneTime));
   ...
   private ReportMailPayload getReportMailPayload(Map<String, Object> reportParameters, boolean exportList,
      ...
      ReportMailPayload reportMailPayload = new ReportMailPayload();
         ...
         reportMailPayload.setFileName(shiftFileNameFormat(FWB_REPORT_NAME, currentZoneTime));
