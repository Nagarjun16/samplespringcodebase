...
public class ProduceOffloadJob extends AbstractCronJob {
   @Autowired
   private ProduceOffloadService poduceOffloadService;
   ...
   protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
      ...
      try {
         result = poduceOffloadService.pushOffloadStatus(value);
   ...
   public BigInteger insertOutgoingMessage(Object payload) {
      ...
      outgoingMessage.setSubMessageType(AirmailStatusEnums.OF.toString());
