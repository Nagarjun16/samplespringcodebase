...
public class ProduceHandoverToAgentDNATAJob extends AbstractCronJob {
   
   @Autowired
   private ProduceHandoverToDNATAService produceHandoverToDNATAService;
   ...
   protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
      ...
      try {
          result = produceHandoverToDNATAService.pushHandoverToDNATAStatus(value);
   ...
   public BigInteger insertOutgoingMessage(Object payload) {
      ...
      outgoingMessage.setSubMessageType(AirmailStatusEnums.TA.toString());
