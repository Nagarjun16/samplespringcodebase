...
public class MappingTableDetailMessageJob extends AbstractCronJob {
   @Autowired
   ...
   private static final String messageName = "TGFMCMBD";
   ...
   protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
      ...
      MssMessageParentModel<List<MappingTableDetailModel>> mappingTableDetailData = null;
      try {
         mappingTableDetailData = service.mappingTableDetailModel(messageName);
      } catch (CustomException e) {
         throw new JobExecutionException(e.getCause());
      }
      // Send batch job data to Connector framework
      if (!CollectionUtils.isEmpty((List) mappingTableDetailData.getData())) {
         delegateToConnector(mappingTableDetailData, messageName);
      }
   }
