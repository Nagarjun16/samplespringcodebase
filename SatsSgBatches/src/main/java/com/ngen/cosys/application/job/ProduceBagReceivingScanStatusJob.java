...
public class ProduceBagReceivingScanStatusJob extends AbstractCronJob {

   @Autowired
   private ProduceBagReceivingScanStatusService produceBagReceivingScanStatusService;
   ...
   protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
      ...
      Object value = jobExecutionContext.getJobDetail().getJobDataMap().get("DIFFMIN");
      try {
         result = produceBagReceivingScanStatusService.pushBagReceivingScanStatus(value);
   ...
   public BigInteger insertOutgoingMessage(Object payload) {
      ...
      outgoingMessage.setSubMessageType(AirmailStatusEnums.AA.toString());
