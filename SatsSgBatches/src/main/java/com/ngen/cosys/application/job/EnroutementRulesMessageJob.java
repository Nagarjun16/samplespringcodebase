...
public class EnroutementRulesMessageJob extends AbstractCronJob {
   @Autowired
   ...
   private static final String messageName = "TGFMENRL";
   ...
   protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
      ...
      MssMessageParentModel<List<EnroutementRulesMessagesModel>> enroutenmentDataList = null;
      try {
         enroutenmentDataList  =  service.enroutementRuleMessages(messageName);
      } catch (CustomException e) {
         throw new JobExecutionException(e.getCause());
      }
      // Send batch job data to Connector framework
      if (!CollectionUtils.isEmpty((List) enroutenmentDataList.getData())) {
         delegateToConnector(enroutenmentDataList, messageName);
      }
   }
