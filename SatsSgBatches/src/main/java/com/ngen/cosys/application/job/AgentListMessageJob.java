...
public class AgentListMessageJob extends AbstractCronJob {
   @Autowired
   ...
   private static final String messageName = "TGFMAGTL";
   ...
   protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
      ...
      MssMessageParentModel<List<AgentListMessageModel>> agentList = null;
      try {
         agentList = service.agentListMessages(messageName);
      } catch (CustomException e) {
         throw new JobExecutionException(e.getCause());
      }
      // Send batch job data to Connector framework
      if (!CollectionUtils.isEmpty((List) agentList.getData())) {
         // send batch job data to connector framework
         delegateToConnector(agentList, messageName);
      }
   }
