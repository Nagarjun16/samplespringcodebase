/**
 * {@link ImpTonnageDailyVerificationFltShpJob}
 * 
...
/**
 * Exp Tonnage Daily Verification Shipment Job
 * 
 * @author NIIT Technologies Ltd
 */
public class ImpTonnageDailyVerificationFltShpJob extends AbstractCronJob {

   private static final Logger LOGGER = LoggerFactory.getLogger(ImpTonnageDailyVerificationFltShpJob.class);
   ...
   protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
      ...
      // Report Payload
         ...
         LOGGER.info("Imp Tonnage Daily Verification Shipment Job :: Imp Tonnage Daily Verification Shipment list sent successfully");
      }
