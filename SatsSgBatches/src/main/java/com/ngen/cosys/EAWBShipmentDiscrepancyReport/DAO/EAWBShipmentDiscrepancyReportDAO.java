...
public interface EAWBShipmentDiscrepancyReportDAO {
   List<String> getShipemntInformationForACarrier() throws CustomException;
   
   List<String> getEmailAddressesForEAWB(String carrierCode) throws CustomException;
   
   List<String> getShipemntInformationForACarrierForNAWB() throws CustomException;
