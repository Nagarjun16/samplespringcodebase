...
@JsonIgnoreProperties(value = { "createdBy", "createdOn", "modifiedBy", "modifiedOn", "flagUpdate", "flagDelete",
      ...
      "terminal", "userType", "sectorId", "shipmentId", "shipmentNumber", "carriercode", "flightId", "manifetsedUld",
       "versionDateTime"  })
@JsonPropertyOrder(value = { "bagStatus", "bagStatusDateTime", "bagConditionCode", "flightNumber", "flightDate" })
