/**
 * FlightManifestCompleteJob.java
 * 
...
import com.ngen.cosys.event.notification.type.FlightManifestComplete;
import com.ngen.cosys.framework.exception.CustomException;
import com.ngen.cosys.scheduler.job.AbstractCronJob;
import com.ngen.cosys.timezone.util.TenantZoneTime;

/**
 * This implementation class is used for Flight Manifest Complete
 * 
 * @author NIIT Technologies Ltd
 */
@Component(value = NotificationEventTypes.MANIFEST_COMPLETE)
public class FlightManifestCompleteJob extends AbstractCronJob implements FlightManifestComplete {

   private static final Logger LOGGER = LoggerFactory.getLogger(FlightManifestCompleteJob.class);
      ...
      if (eventConfigured) {
         try {
            ...
            if (eventNotificationAvailability) {
               flightManifestCompleteEvent(eventNotificationModel);
            }
   ...
   /**
    * @see com.ngen.cosys.event.notification.type.FlightManifestComplete#flightManifestCompleteEvent(com.ngen.cosys.event.notification.model.EventNotificationModel)
    */
   @Override
   public void flightManifestCompleteEvent(EventNotificationModel eventNotificationModel) throws CustomException {
      LOGGER.debug("{} Entity and {} Event Type notification started", entity, eventType);
      // Not completed flight details
      List<FlightEvents> flightDetails = flightManifestCompleteService.getManifestNotCompletedFlights(eventType);
